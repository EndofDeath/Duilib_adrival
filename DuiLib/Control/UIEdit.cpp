...
namespace DuiLib
{
	...
	CEditUI::CEditUI() : m_pWindow(NULL), m_uMaxChar(255), m_bReadOnly(false), 
		...
		m_dwEditbkColor(0xFFFFFFFF), m_iWindowStyls(0), m_dwReadonlyBkcolor(0xfff5f5f5)
	{
	...
	void CEditUI::SetReadonlyBkColor(DWORD dwBkColor)
	{
		m_dwReadonlyBkcolor = dwBkColor;
	}

	DWORD CEditUI::GetReadonlyBkColor() const
	{
		return m_dwReadonlyBkcolor;
	}
